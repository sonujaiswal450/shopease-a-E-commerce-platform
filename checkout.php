...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="Kolkata" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>State:</span>
         ...
         <div class="inputBox">
            <span>ZIP CODE :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 711111" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
